...
<body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container flex-lg-column">
            <a href="#" class="navbar-brand mx-lg-auto mb-lg-4">
                <span class="h3 fw-bold d-block d-lg-none">Achraf Hallouly</span>
                <img src="./assets/images/perso-img.jpg" class="d-none d-lg-block rounded-circle">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto flex-lg-column text-lg-center">
                    ...
                    <li class="nav-item">
                        <a href="Home" class="nav-link">Work</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <h1 class="display-4 fw-bold" data-aos="fade-up">I'M A <span class="text-brand">Web Developer
                                <br></span>FROM MOROCCO</h1>
                        <p class="lead-mt-2 mb-4" data-aos="fade-up" data-aos-delay="300">I am Achraf Hallouly, I create
                            the Websites (FRONT-End & BACK-END), And I make an amazing portfolios,<br>
                         i'm also a video editor and a social media manager.
                        </p>
                        <div data-aos="fade-up" data-aos-delay="600">
                            <a href="https://uinvestmc.github.io/uinvestmasterclass/" target="_blank" class="btn btn-brand me-3">Explore My Work</a>
                            <a href=" https://wa.me/212656955298" target="_blank" class="link-custom">MSG_WTSP: (212) 0656955298</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gy-4">
                    <div class="col-md-4" data-aos="fade-up">
                        <div class="service p-4 bg-base rounded-4 shadow-effect">
                            ...
                            <h5 class="mt-4 mb-2">Web Developement</h5>
                    ...
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                        <div class="service p-4 bg-base rounded-4 shadow-effect">
                            ...
                            <h5 class="mt-4 mb-2">Social Media Management</h5>
                            <p>I craft high-performing and delightful experiences tailored and conversion-focused</p>
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    <div class="col-md-6" data-aos="fade-up">
                        <div class="card-custom rounded-4 bg-base shadow-effect">
                            <div class="card-custom-image rounded-4">
                                <img src="./assets/images/mazrai3.png" class="rounded-4" alt="">
                            </div>
                            <div class="card-custom-content p-4">
                                ...
                                <a href="https://uinvestmc.github.io/uinvestmasterclass/" target="_blank" class="link-custom">Read More</a>
                        </div>
                        </div>
                    </div>
                    <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="card-custom rounded-4 bg-base shadow-effect">
                            <div class="card-custom-image rounded-4">
                                <img src="./assets/images/B.jpg" class="rounded-4" alt="">
                            </div>
                            <div class="card-custom-content p-4">
                                <h4>Portfolio</h4>
                                <p>Innovation that exceeds expectations. Astra is a true template equiqed with all the elements you could ever need to put together</p>
                                <a href="Home" class="link-custom">Read More</a>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-lg-8 pb-4" data-aos="fade-up">
                                <h6 class="text-uppercase text-light">CONTACT</h6>
...
?>
                            ...
                            <div class="col-lg-8" data-aos="fade-up" data-aos-delay="300">
                                <form action="Home" method="post"  class="row g-lg-3 gy-3">
